...
- **Open Science** 
  - research → transparent and accessible  
- **Open Access**
  - publishing → results freely available  
- **Reproducible research**
  - practices → trust & verification  
...
- Research outputs go **beyond papers** → **data is central**  
- The **explosion & heterogeneity** of data create new challenges  
...
- Provides the policy framework for how projects should manage data  
  → *Practical requirements are covered in the **How to Guide** section*  
