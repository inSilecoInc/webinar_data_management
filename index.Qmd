...
- among which data is increasingling important 
- more than paper https://www.crossref.org/services/event-data/
...
- ArcticNet’s commitment to its members to facilitate data management
- ArcticNet’s expectations towards its members in terms of data management
- Training and practical guidance for data management
...
- Who is sresponsible of what


## Role of the network 

- Support researchers is writting their DMP 
- Ideally foreseeing potential synergy among researchers for data collection
- Training: RDM 101
...
- During early analysis, right down the metadata
...
- supporting researchers in writting metadata
